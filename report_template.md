...
- Séries : normalisation par canal, fenêtrage = 128 pas de temps (longueur fixe, pas de fenêtrage supplémentaire), reshape (N,T,C) → (N,C,T), dtype = float32
...
- Liste des **augmentations** (opérations + **paramètres** et **probabilités**) :
  ...
  - Séries : Jitter : ajout de bruit gaussien, amplitude (σ = 0.01), probabilité p=0.5, scaling = multiplication par facteur aléatoire N(1.0, 0.1), probabilité p=0.5
